...
| FR-REL-002 | 사용자는 상대방 별명을 입력하고, 상대방 출생정보는 선택적으로 입력할 수 있다 | P0 | 3 | S10 | 동일 | E2E-06 |
| FR-REL-003 | 서비스는 나의 원석, 상대의 원석(선택), 우리의 원석을 산출한다 | P0 | 3 | S12 | 동일 | E2E-06 |
| FR-REL-004 | 결과 화면은 관계 대화 질문과 작은 행동을 제공한다 | P1 | 3 | S12 | 동일 | E2E-06 |
| FR-REL-005 | 사용자는 상대방을 초대할 수 있는 링크를 생성할 수 있다 | P1 | 3 | S12 | 동일 (`inviteLink` 필드) | E2E-06 |
| FR-REL-006 | 상대방이 초대에 응하면 양방향 관계 결과를 제공한다 | P2 | 3 | S12 | `추가 검증 필요`: 상대방 응답 전용 엔드포인트 | E2E-06 |
...
FR-BASIC-001~015, NFR-SEC-001/003/004, NFR-PERF-001~003, NFR-A11Y-001~003. 화면 S01~S05.
